...
DevEvent        WiFiTools::dev_queue[WiFiTools::DEV_QUEUE];
volatile int    WiFiTools::dev_head = 0;
volatile int    WiFiTools::dev_tail = 0;
volatile uint32_t WiFiTools::eapol_count = 0;
volatile uint32_t WiFiTools::frames_captured = 0;
portMUX_TYPE    WiFiTools::cap_mux = portMUX_INITIALIZER_UNLOCKED;
