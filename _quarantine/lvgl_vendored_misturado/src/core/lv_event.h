...
/**
 * Used as the event parameter of ::LV_EVENT_HIT_TEST to check if a `point` can click the object or not.
 ...
 *
 * The actual lv_hit_test_info_t type is declared in lv_types.h and defined in lv_obj_event_private.h.
 */
 ...
 *
 * The actual lv_cover_check_info_t type is declared in lv_types.h and defined in lv_obj_event_private.h.
 */
