...
// HTML principal da WebUI do Mini Lele.
// Mantido como string raw para simplicidade; gzip real pode ser
...
<body>
    <div class="container py-4">
        <h1 class="text-center mb-4" style="text-shadow: 0 0 10px var(--neon-purple);">
            Mini Lele <span class="badge bg-danger">v2.0</span>
        </h1>
        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item">
                <button class="nav-link active" data-bs-target="#tab-config" data-bs-toggle="tab">Configurações</button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-target="#tab-files" data-bs-toggle="tab">Arquivos</button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-target="#tab-logs" data-bs-toggle="tab">Logs</button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-target="#tab-system" data-bs-toggle="tab">Sistema</button>
            </li>
        </ul>
            ...
            for (const [key, val] of Object.entries(data)) {
                ...
                if (typeof val === 'boolean') {
                    input = `<div class="form-check form-switch">
                               <input class="form-check-input" type="checkbox" id="${key}" ${val ? 'checked' : ''}>
                             </div>`;
                } else {
